    ...
    return(
        <><div className="sign">
            <h4 className="simple-title">
                ...
                <a href="#" class="simple-link"> <i className="fa fa-link"></i>The Simple Solution
</a>

            </h4>
        </div><div className="simple">
       <b> Thought experiments make it obvious that this idea is memetic, and just has not been tried in the market. Once one initial company opens up this model, many more will follow and copy:</b>
            </div>
            ...
            <div className="simple-img">
                <img class="next-img"src="https://redefinestatus.com/_next/image?url=https%3A%2F%2Fwww.notion.so%2Fimage%2Fhttps%253A%252F%252Fs3-us-west-2.amazonaws.com%252Fsecure.notion-static.com%252F569cc3d3-0559-487b-a125-eb72a4d91ab8%252FScreen_Shot_2023-03-08_at_10.16.09_PM.png%3Ftable%3Dblock%26id%3Da24b96b7-d44c-429d-9241-9bc1c046c223%26cache%3Dv2&w=2048&q=75"></img>
            </div>
            <div className="deep-space3">&nbsp;</div>
