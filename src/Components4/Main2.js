...
function Main2(){
    return(
        ...
        <h4 class="deep-title">
                ...
                <a href="#" class="deep-link">
                <i className="fa fa-link"></i>Deep Dive</a>
        ...
        <div className="deep-space3">&nbsp;</div>

        <div className="deep">
            <b>Status is what we are buying when we pay $1, $10, or even $500 extra for a certain brand of T-Shirt irrespective of comfort.</b>
        </div>

        <div className="deep-space4">&nbsp;</div>
        ...
        <div className="deep-space9">&nbsp;</div>
    
    
    <blockquote class="deeptw">
    The personal luxury goods market is projected to grow from USD<a class="no-link" href="https://www.fortunebusinessinsights.com/luxury-goods-market-103866">257.26 billion in 2020 to USD 352.84 billion in 2027</a>

</blockquote>
<div className="deep-space10">&nbsp;</div>
    
<blockquote class="deeptw">
The Luxury Cars Market size is expected to grow from<a target="_blank" rel="noopener noreferrer" class="no-link" href="https://www.globenewswire.com/en/news-release/2022/09/19/2518123/0/en/Luxury-Cars-Market-Size-Worth-USD-655-0-Billion-Globally-by-2027-at-9-3-CAGR.html#:~:text=The%20Luxury%20Cars%20Market%20size,9.3%25%20from%202020%20to%202027.&amp;text=Pune%2C%20India%2C%20Sept.,by%20the%20end%20of%202027."><b><b>USD 449.7 Billion in 2019 to USD 655.0 Billion by 2027; It is estimated to grow at a CAGR of 9.3% from 2020 to 2027.</b></b></a>
    </blockquote>
    <div className="deep-space11">&nbsp;</div>
    <div className="deep">
        While the larger belief is that this systemic change is the real impact in realigning our culture towards true status, the amount of funds in status spending that could be redirected towards positive causes is also no joke. 
        </div>

        <div className="deep-space12">&nbsp;</div>
